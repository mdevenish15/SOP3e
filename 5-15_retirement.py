...
def show_pay_contrib(gross):
    ...
    print('Contributions for gross pay: $', format(contrib, ',.2f'), sep='')

# the show_bonus_contrib function accepts the bonus amount as an argument and displays the retirement
# contribution for that amount of pay
