...
def main():
    ...
    # get the search value from the user and the new quantity
    search = input('Enter a decription to search for: ')
    ...
    while descr != '':
        ...
        # write either this record to the temporary file or the new record if this is
        # the one that is to be modified
        if descr == search:
